...
variable "instance_type" {
  type        = string
  default     = "t3.micro"
  description = "EC2 instance type for the ASG (Flask app instances)"
}

variable "postgres_instance_type" {
  type        = string
  default     = "t3.micro"
  description = "EC2 instance type for the dedicated Postgres instance"
}
...
variable "app_repo_url" {
  type        = string
  description = "Git repo URL to clone on each EC2 instance"
  # Example: "https://github.com/youruser/todo-api.git"
}
